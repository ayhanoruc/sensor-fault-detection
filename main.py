...
async def predict_route ():
    ...
    try:
        #get data from user csv
        # convert csv file to dataframe
        df= None

        # obtain train df
        # upload train df 
        # calculate the data drift, if drift is signifant then trigger an email to datascientist team 
        ...
        #decide how to return the output to user
